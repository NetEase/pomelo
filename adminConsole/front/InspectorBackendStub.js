...
InspectorBackend.registerCommand("Profiler.start", [{"name": "uid", "type": "string", "optional": false}], []);
InspectorBackend.registerCommand("Profiler.stop", [{"name": "uid", "type": "string", "optional": false}], []);
InspectorBackend.registerCommand("Profiler.getProfileHeaders", [], ["headers"]);
InspectorBackend.registerCommand("Profiler.getProfile", [{"name": "type", "type": "string", "optional": false}, {"name": "uid", "type": "string", "optional": false}], ["profile"]);
InspectorBackend.registerCommand("Profiler.removeProfile", [{"name": "type", "type": "string", "optional": false}, {"name": "uid", "type": "string", "optional": false}], []);
InspectorBackend.registerCommand("Profiler.clearProfiles", [], []);
InspectorBackend.registerCommand("Profiler.takeHeapSnapshot", [{"name": "uid", "type": "string", "optional": false}], []);
