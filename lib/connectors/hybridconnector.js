...
Connector.decode = Connector.prototype.decode = function(msg) {
  ...
  } else if(!!this.decodeIO_protobuf && !!this.decodeIO_protobuf.check(route)) {
    msg.body = this.decodeIO_protobuf.build(route).decode(msg.body);
  } else {
...
var encodeBody = function(server, route, msgBody) {
  ...
  } else if(!!server.decodeIO_protobuf && !!server.decodeIO_protobuf.check(route)) {
     msgBody = server.decodeIO_protobuf.encode(server.decodeIO_protobuf.build(route), msgBody);
  } else {
