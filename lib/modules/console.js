...
// 2 minutes timeout to wait for acks from servers
var MASTER_WAIT_KILL = 2 * 60 * 1000;

// delay 2 seconds then exit after receiving signal `kill`
...
var kill = function(app, agent, msg, cb) {
  ...
  var latch = countDownLatch.createCountDownLatch(count, {timeout: MASTER_WAIT_KILL}, function(isTimeout) {
    if (!isTimeout) {
