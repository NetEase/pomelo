...
exports.defaultConfig=function(app){
  app.configure(function(){
    ...
    app.configAreas();
    app.configLog(app.get('dirname')+'/config/log4js.json');
...
var initServers = function(app) {
  ...
  for(var type in servers) {
    app.configure('production|development', type, function(){
        app.set('server', app.findServer(app.get('serverType'), app.get('serverId')));    	  
