...
/**
 * Set before close function. It would perform before servers stop.
 *
 * @param  {Function} fun before close function
 * @return {Void}
 * @memberOf Application
 */
Application.close = function(fun) {
  if(typeof fun !== 'function') {
    logger.warn('only function is allowed to set.');
    return;
  }
  this.set('__close__', fun);
};
