...
Application.start = function(cb) {
  ...
  if(!!this.lifecycleCallbacks['beforeStartup']) {
    this.lifecycleCallbacks['beforeStartup'].call(null, this, startUp);
  } else {
    startUp();
  }
};
...
Application.stop = function(force) {
  ...
  if(!!this.lifecycleCallbacks['beforeShutdown']) {
    this.lifecycleCallbacks['beforeShutdown'].call(null, this, shutDown);
  } else if(!!fun) {
