...
var logger = require('pomelo-logger-x').getLogger('pomelo', __filename);
var transactionLogger = require('pomelo-logger-x').getLogger('transaction-log', __filename);
var transactionErrorLogger = require('pomelo-logger-x').getLogger('transaction-error-log', __filename);
