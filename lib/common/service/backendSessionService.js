...
/**
 * Push the onClose handler to the frontend internal session.
 * @param frontendId
 * @param sid
 * @param handler
 * @param cb
 */
BackendSessionService.prototype.onClose = function(frontendId, sid, handler, cb) {
    var namespace = 'sys';
    var service = 'sessionRemote';
    var method = 'onClose';
    var args = [sid, handler];
    rpcInvoke(this.app, frontendId, namespace, service, method, args, cb);
};
...
/**
 * Push the handler in backend session to the frontend internal session.
 * @param handler
 * @param cb
 */
BackendSession.prototype.onClose = function(handler, cb) {
    this.__sessionService__.onClose(this.frontendId, this.id, handler, cb);
};
