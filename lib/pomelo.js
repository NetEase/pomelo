 ...
 */
Pomelo.managers = {};
Pomelo.managers.__defineGetter__('redisGlobalChannelManager', function() {
  return require('./common/manager/redisGlobalChannelManager');
});

Pomelo.managers.__defineGetter__('statusManager', function() {
  return require('./common/manager/statusManager');
});
