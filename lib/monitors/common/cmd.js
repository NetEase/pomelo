...
var show = function(client, msg) {
  var result;
  switch(msg.param) {
    case 'connections':
      result = getConnectionInfo(client);
      break;
    case 'logins':
      result = getLoginInfo(client);
      break;
    case 'modules':
      result = getModuleInfo(client);
      break;
    case 'status':
      result = getStatusInfo(client);
      break;
    case 'proxy':
      result = getProxyInfo(client);
      break;
    case 'handler':
      result = getHandlerInfo(client);
      break;
    case 'components':
      result = getComponentInfo(client);
      break;
    case 'settings':
      result = getSettingInfo(client);
      break;
    default:
      result = {};
      break;
...
var getConnectionInfo = function(client) {
  ...
  return {serverId : connectionInfo};
};
...
var getHandlerInfo = function(client) {
  ...
  return {handlerInfo: handlerInfo};
};
...
var getSettingInfo = function(client) {
  ...
  return {settingInfo: res};
};

var getStatusInfo = function(client) {
  var statusInfo = {};
  return {statusInfo: statusInfo};
};

var getLoginInfo = function(client) {
  var loginInfo = {};
  return {loginInfo: loginInfo};
};

var getModuleInfo = function(client) {
  var moduleInfo = {};
