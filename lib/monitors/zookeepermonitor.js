...
var registerZK = function(zk, cb) {
  ...
  allInfo.connectionInfo = connectionInfo;

  allInfo.loginInfo = connectionInfo;
  ...
  if (__proxy__ && __proxy__.client && __proxy__.client.proxies.user) {
    ...
    if (!server) {
      ...
      allInfo.proxyInfo = proxyInfo;
    }
  } else {
    allInfo.proxyInfo = 'no proxy loaded';
  }
  ...
  if (__server__ && __server__.server && __server__.server.handlerService.handlers) {
    ...
    if (!server) {
      ...
      allInfo.handlerInfo = handlerInfo;
    }
  } else {
    allInfo.handlerInfo = 'no handler loaded';
  }
