...
var pinfo = require('pomelo-logger').getLogger('pinfo', 'master');
var perror = require('pomelo-logger').getLogger('perror', 'master');
...
starter.sshrun = function (cmd, host, cb) {
  pinfo.info('Executing ' + cmd + ' on ' + host);
...
starter.localrun = function (cmd,host,options,callback) {
  pinfo.info('Executing ' + cmd + ' ' + options + ' locally');
