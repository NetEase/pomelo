  ...
  register: function() {
    ...
    setInterval(function(){
       ...
       for(var nodeId in nodes){
       	...
       	reString.push({'nodeId':nodeId,'nodeType':nodes[nodeId].nodeType,'hostName':msg.body.hostname,'freeMen/totalMem':msg.body.freemem/msg.body.totalmem,'loadAvg':msg.body.loadavg,
       	  'cpu':JSON.stringify((msg.body.cpus)[0].times)});
       	}); 	
       }
       log_server.io.sockets.in('web_clients').emit('gkGrid',{'nodes':reString});
    },1000);
